Dhis2Api.directive('d2Drowdowndataset', function(){
	return{
		restrict: 'E',
		templateUrl: 'directives/datset/dataSetView.html'
	}
	}); 
Dhis2Api.controller("d2DrowdowndatasetController", ['$scope','$http', 'GetDatasetDAppr',function ($scope, $http,GetOrganisationunit) {
