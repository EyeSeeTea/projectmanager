...
export const dataExport = ["$scope", "$q", "$filter", "commonvariable", "DataSetsUID", "DataExport", "DemographicsService", "MetadataSyncService", '$timeout',
	function ($scope, $q: ng.IQService, $filter, commonvariable, DataSetsUID, DataExport, DemographicsService, MetadataSyncService, $timeout) {
		...
		$scope.submit_sync = function () {
			...
			MetadataSyncService.isRemoteServerAvailable().then(
				data => {
